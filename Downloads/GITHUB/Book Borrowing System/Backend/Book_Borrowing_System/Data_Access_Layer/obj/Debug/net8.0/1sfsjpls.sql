...
CREATE TABLE [Books] (
    ...
    CONSTRAINT [FK_Books_Users_CurrentlyBorrowedById] FOREIGN KEY ([CurrentlyBorrowedById]) REFERENCES [Users] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Books_Users_LentByUserId] FOREIGN KEY ([LentByUserId]) REFERENCES [Users] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES (N'20231124061649_Initil', N'8.0.0');
GO
